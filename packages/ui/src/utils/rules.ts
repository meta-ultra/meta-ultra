...
const isMobilePhonePredicate = (value: string) =>
  /^(13[0-9]|14[014-9]|15[0-35-9]|16[2567]|17[0-8]|18[0-9]|19[0-35-9])\d{8}$/.test(
    value
  );
const isMobilePhone = createRule(
  isMobilePhonePredicate,
  "请输入有效的手机号码"
);

const isValidAccountPredicate = (value: string) =>
...
export default { createRule, isMobilePhone, isValidAccount };
